...
namespace Assets.Scripts.CardModule.CardStates
{
    public class CardDownChangePre : CardState
    {
        ...
        public override void StateStart()
        {
            ...
            selectionWindow.ShowCardSelectionWindow(upChangeDeck.GetWuXingChangeCardList(Controller.Card, WuxingChangeType.NiKe, player.ActionPoint), OnFinishSelectCardCallBack, player.gameObject);
